    ...
    def _create_inference(self):
        with tf.name_scope("inference"):
            ...
            for k in range(1, self.num_gcn_layers + 1):
                ...
                ######################## jiaquan ###############################
                insts_event_embedding = args.weight_11 * insts_event_embedding_1 + (1-args.weight_11) * insts_event_embedding_2
...
if __name__ == '__main__':
    ...
    fh = logging.FileHandler('%s/logs/%s-%s/%s_%s_11_jiaquan.log' %
    ...
    Hyperparameters = ['model_name', 'dataset', 'epoch', 'batch_size', 'test_batch_size', 'test_interval', 'stop_cnt',
                       'decoder_type', 'hidden_factor',  'lr', 'pretrain', 'reg',
                       'init_method', 'stddev', 'topk', 'num_gcn_layers', 'gcn_layer_weight', 'merge_type',
                       'adj_norm_type', 'intent_weight','weight_11']
