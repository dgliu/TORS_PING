        ...
        with tf.name_scope("inference"):
            ...
            for k in range(1, self.num_gcn_layers + 1):
                ...
                if self.adj_norm_type in ['ls', 'db']:
                    ...
                    layer_item_embedding = tf.concat([layer_item_embedding_1, layer_item_embedding_2], axis=-1) # [m, 2d]
                    layer_item_embedding = tf.matmul(layer_item_embedding, self.W_pinjie)   #[m, d]
                    ##############################   End  ####################################
