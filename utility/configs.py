...
def parse_args():
    parser = argparse.ArgumentParser(description="Run UEG.")
    parser.add_argument('--num_factors', type=int, default=4,
                        help='the number of intent')

    parser.add_argument('--intent_weight', type=float, default= 0.5,
                        help='the weight between KG intent and UEG intent.')
    ...
    parser.add_argument('--dataset', nargs='?', default='Yelp',
                        help='Choose a dataset: LFM, Yelp, or Amazon-Book')
    ...
    parser.add_argument('--test_interval', type=int, default=1,
                        help='Test interval.')
    parser.add_argument('--stop_cnt', type=int, default=10,
                        help='stop count')
    parser.add_argument('--topk', nargs='?', default='[20]',
                        help='Top K')  # can be change
    ...
    parser.add_argument('--keep_rate', type=float, default=0.5,
                        help='keep_rate.')
    parser.add_argument('--weight_11', type=float, default=0.5,
                        help='weight_11.')
...
def post_process_for_config(args, model_name):
    ...
    if model_name in ['GCM', 'PING', 'LightGCN']:
